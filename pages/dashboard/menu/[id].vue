          ...
          <div class="px-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="profile" role="tabpanel"
            ...
            <div class="flex flex-wrap w-full">
              <div v-if="categoryItems.items.length !== 0"
                   class="bg-gray-100 p-6 rounded-lg w-1/4 flex flex-col items-center mx-1 my-1 cursor-pointer"
                   v-for="item in categoryItems.items" @click="viewItem(item)">
...
const viewItem = (item: ICreateCategoryItem) => {
